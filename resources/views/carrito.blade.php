                ...
                <div class="col-xl-9 col-md-8">
                    ...
                    <div class="d-sm-flex justify-content-between my-4 pb-4 border-bottom">
                        <div class="media d-block d-sm-flex text-center text-sm-left">
                            ...
                            <div class="media-body pt-3">
                                <h3 class="product-card-title font-weight-semibold border-0 pb-0 ml-3"><a href="#">Calvin Klein Jeans Keds</a></h3>
                    ...
                    <div class="d-sm-flex justify-content-between my-4 pb-4 border-bottom">
                        <div class="media d-block d-sm-flex text-center text-sm-left">
                            ...
                            <div class="media-body pt-3">
                                <h3 class="product-card-title font-weight-semibold border-0 pb-0 ml-3"><a href="#">The North Face Hoodie</a></h3>
                    ...
                    <div class="d-sm-flex justify-content-between my-4 pb-4 border-bottom">
                        <div class="media d-block d-sm-flex text-center text-sm-left">
                            ...
                            <div class="media-body pt-3">
                                <h3 class="product-card-title font-weight-semibold border-0 pb-0 ml-3"><a href="#">Medicine Chameleon Sunglasses</a></h3>
                    ...
                    <div class="d-sm-flex justify-content-between my-4">
                        <div class="media d-block d-sm-flex text-center text-sm-left">
                            ...
                            <div class="media-body pt-3">
                                <h3 class="product-card-title font-weight-semibold border-0 pb-0 ml-3"><a href="#">Adidas Performance Hat</a></h3>
